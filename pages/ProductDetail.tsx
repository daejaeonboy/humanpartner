                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100">
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 py-3 rounded-xl border-2 border-[#39B54A] text-[#39B54A] font-semibold hover:bg-[#39B54A]/5 transition-all"
                    >
                      <FileText size={18} />
                      견적서 다운로드 (PDF)
                    </button>
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4" onClick={() => {
          ...
          >
            ...
            <button
              ...
              className="w-full py-3 bg-[#39B54A] text-white font-bold rounded-xl hover:bg-[#39B54A] transition-colors shadow-sm"
            >
              확인
            </button>
          </div>
