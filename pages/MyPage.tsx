                                            ...
                                            <div className="p-5">
                                                ...
                                                {(booking.selected_options?.length || 0) + (booking.basic_components?.length || 0) > 0 && (
                                                     <button
                                                        ...
                                                        className="w-full py-4 bg-[#39B54A] text-white rounded-xl text-base font-bold hover:bg-[#39B54A] transition-all shadow-md active:scale-[0.98]"
                                                    >
                                                        예약 내역보기
                                                    </button>
                                                )}
                                                ...
                                                <div className="flex gap-2 w-full md:w-auto">
                                                    {(booking.selected_options?.length || 0) + (booking.basic_components?.length || 0) > 0 && (
                                                        <button
                                                            ...
                                                            className="px-5 py-2.5 bg-[#39B54A] text-white rounded-lg text-sm font-bold hover:bg-[#39B54A] transition-all shadow-sm flex items-center gap-2"
                                                        >
                                                            상세 구성 내역
                                                        </button>
                                                    )}
