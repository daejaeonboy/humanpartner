                ...
                <div className="w-full max-w-xl md:max-w-3xl mx-auto bg-white p-6 md:p-16 rounded-3xl shadow-lg border border-gray-100 mb-20">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className={`w-full text-white py-3 md:py-4 rounded-lg font-bold transition-all mt-4 md:mt-6 ${loading ? 'bg-gray-400 cursor-not-allowed' : 'bg-[#39B54A] hover:bg-[#39B54A]'}`}
                        >
                            {loading ? '로그인 중...' : '로그인하기'}
                        </button>
                    </form>
