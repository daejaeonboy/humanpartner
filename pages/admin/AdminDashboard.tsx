...
export const AdminDashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            {/* Admin Header */}
            <header className="bg-gradient-to-r from-[#39B54A] to-[#39B54A] text-white py-4 px-6 flex items-center justify-between shadow-lg">
                    ...
                    {isRoot ? (
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        <div className="p-4 bg-gradient-to-br from-[#39B54A]/10 to-[#39B54A]/5 rounded-xl group-hover:from-[#39B54A] group-hover:to-[#39B54A] transition-all duration-300">
