                ...
                <div className="flex flex-col lg:flex-row justify-between items-start gap-8 lg:gap-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 sm:gap-10 shrink-0">
                        ...
                        <div className="w-full sm:w-auto">
                            <h3 className="font-bold text-gray-800 mb-2 text-[15px] tracking-wide">C/S CENTER</h3>
                        ...
                        <div className="flex items-start pt-6 sm:pt-0 border-t sm:border-t-0 border-gray-100 relative sm:pl-10">
                            ...
                            <div>
                                <h3 className="font-bold text-gray-800 mb-2 text-[15px] tracking-wide">입금계좌</h3>
                                <div className="text-gray-800 font-bold text-base mb-1 tracking-tight">
                    ...
                    <div className="flex-1 lg:pl-10 pt-6 lg:pt-0 border-t lg:border-t-0 border-gray-100 w-full relative">
                        ...
                        <div className="text-[13px] leading-6 md:leading-7 text-gray-500">
                            <p>
                                법인명(상호) : 행사어때 <span className="mx-2 text-gray-300">|</span> 대표자(성명) : 이기섭 <span className="mx-2 text-gray-300">|</span> 사업자 등록번호 : 305-30-85537
                            </p>
                            <p>
                            ...
                            <p className="mt-5 text-[12px] text-gray-400 font-medium">
                ...
                {!isProductDetailPage && (
                    <div className="fixed bottom-24 md:bottom-6 right-4 md:right-6 z-[60] flex flex-col gap-2">
                        <a
                            ...
                            title="카카오톡 상담"
                        >
                            <img src="/kakao.png" alt="카카오톡 채널" className="w-10 h-10 md:w-12 md:h-12" decoding="async" />
                        </a>

                        <button
                            onClick={scrollToTop}
                            className="w-10 h-10 md:w-12 md:h-12 bg-[#39B54A] text-white hover:bg-[#2e933c] transition-all flex items-center justify-center rounded-none"
